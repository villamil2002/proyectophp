<?php
    ...
    if(isset($_POST['actualizar'])){
        ...
        $query = "UPDATE mecanico SET Numero_Documento = '$nidentidad', Tipo_documento = '$tDocumento',Nombre1 = '$nombre1',Nombre2 = '$nombre2',Apellido1 = '$apellido1',Apellido2 = '$apellido2',Direccion = '$direccion',Telefono = '$telefono' WHERE Id_Mecanico = $id";
...
<nav class="navbar navbar-dark bg-dark">
        <div class="container">
            <a href="registroMecanico.php" class="navbar-brand"> EDITAR MECANICO </a>
        </div>
</nav>
