...
<head>
    ...
    <title>Administracion talleres</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="inicio_1.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Opciones :</h6>
                        <a class="collapse-item" href="#">Mecanico</a>
                        <a class="collapse-item" href="repuesto.php">Repuestos</a>
                        <a class="collapse-item" href="ordenParte.php">Orden de parte</a>
